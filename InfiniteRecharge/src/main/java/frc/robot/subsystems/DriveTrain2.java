...
public class DriveTrain extends SubsystemBase {
   ...
   */
   ...
   private final WPI_TalonFX frontRightTalon = new WPI_TalonFX(20);// these port/id values will need to be transferred to RobotMap.java
   private final WPI_TalonFX frontLeftTalon = new WPI_TalonFX(23);
   private final WPI_TalonFX backRightTalon = new WPI_TalonFX(22);
   private final WPI_TalonFX backLeftTalon = new WPI_TalonFX(21);
  //  private final WPI_TalonFX topRightTalon = new WPI_TalonFX(24);
  //  private final WPI_TalonFX topLeftTalon = new WPI_TalonFX(25);
